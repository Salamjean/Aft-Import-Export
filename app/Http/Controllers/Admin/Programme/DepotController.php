...
class DepotController extends Controller
{
    public function index()
    {
        ...
        $programmesCount = Depot::where('statut', 'programme')->count();
        $enCoursCount = Depot::where('statut', 'en_cours')->count();
        $terminesCount = Depot::where('statut', 'termine')->count();
        
        return view('admin.depot.index', compact(
            'depots', 
            'chauffeurs',
            'totalDepots',
            'programmesCount',
    ...
    public function depot(){
        ...
        return view('admin.depot.create',compact('chauffeurs'));
    }
   ...
   public function etiquettes($id)
    {
        try {
            ...
            return view('admin.depot.etiquette', compact('depot', 'codes'));
            
        } catch (\Exception $e) {
            return response()->view('admin.depot.etiquette', [
                'depot' => null,
                'codes' => [],
   ...
   public function downloadEtiquettes($id)
{
    try {
        ...
        $pdf = PDF::loadView('admin.depot.etiquette', compact('depot', 'codes'))
