...
namespace App\Http\Controllers\Admin\Chauffeur;
...
class ChauffeurController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.chauffeur.index', compact('chauffeurs', 'agences'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.chauffeur.create', compact('agences','chauffeurs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('chauffeur.create')
    ...
    public function edit(Chauffeur $chauffeur)
    {
        ...
        return view('admin.chauffeur.edit', compact('chauffeur', 'agences'));
    }
    ...
    public function archived()
    {
        ...
        return view('admin.chauffeur.archived', compact('chauffeurs'));
    }
