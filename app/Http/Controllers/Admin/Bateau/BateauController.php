...
namespace App\Http\Controllers\Admin\Bateau;
...
class BateauController extends Controller
{
    public function planifier(){
        return view('admin.bateau.planifier');
    }

    public function ouvrir(){
        return view('admin.bateau.ouvrir');
    }
    ...
    public function index()
    {
        ...
        return view('admin.bateau.index', compact('planifications'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bateau.index')->with('success', 'Transport planifié avec succès! Référence: ' . $reference);
    }
...
public function showConteneur($id)
{
    ...
    return view('admin.bateau.ouvrir', compact('bateau'));
}
