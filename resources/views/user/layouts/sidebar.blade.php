<aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open" style="background-color: #ffeaca">
      ...
      <div class="mdc-drawer__content">
        <div class="user-info">
          <p class="name text-center text-black"> {{Auth::guard('web')->user()->name}} {{Auth::guard('web')->user()->prenom}}</p>
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              ...
              <div class="mdc-expansion-panel" id="ui-sub-perso">
                <nav class="mdc-list mdc-drawer-submenu">
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="{{route('user.devis.create')}}">
                      faire une demande
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="{{route('user.devis.attente')}}">
                      En attente
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="{{route('user.devis.confirmed')}}">
                      Validé
                    </a>
                  </div>
                </nav>
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="{{route('user.colis.index')}}">
