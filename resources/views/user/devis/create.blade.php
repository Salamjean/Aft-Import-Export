            ...
            <div class="col-12 col-lg-10">
                ...
                ">
                        <div class="text-center">
                            ...
                            <p class="mb-0 opacity-90">Remplissez les informations pour obtenir votre tarification
                                personnalisée</p>
                        </div>
                    </div>
                        ...
                        <div class="progress-container mb-5">
                            <div class="progress" style="height: 10px; border-radius: 10px; background-color: #f8f9fa;">
                                <div class="progress-bar" role="progressbar"
                                    style="width: 0%; border-radius: 10px; background: linear-gradient(135deg, #fea219 0%, #e69100 100%);"
                                    id="progress-bar"></div>
                            </div>
                        </div>
                        ...
                        <form id="tarificationForm" action="{{ route('user.devis.store') }}" method="POST"
                            ...
                            <div class="step-content" id="step-1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-start-0" id="mode_transit"
                                                    name="mode_transit" style="border-radius: 0 10px 10px 0; height: 50px;"
                                                    required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control border-start-0" id="pays_expedition"
                                ...
                                <div class="row g-4 mt-2">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="agence_expedition" class="form-label fw-bold"
                                                style="color: #0e914b;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control border-start-0"
                                                    id="agence_expedition" name="agence_expedition" readonly required
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="agence_destination" class="form-label fw-bold"
                                                style="color: #0e914b;">
                            ...
                            <div class="step-content d-none" id="step-2">
                                ...
                                <p style="color: red">Pour les devis de <span style="font-weight: bold">FRANCE</span> les
                                    valeurs sont en EURO et pour <span style="font-weight: bold">CHINE</span> en FCFA</p>
                                <div class="info-card"
                                    style="
                            ...
                            ">
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            ...
                                            ">
                                                ...
                                                <input type="hidden" id="name_client" name="name_client"
                                                    value="{{ $user->name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            ">
                                                ...
                                                <input type="hidden" id="prenom_client" name="prenom_client"
                                                    value="{{ $user->prenom }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-4 mt-2">
                                        <div class="col-md-6">
                                            ...
                                            ">
                                                ...
                                                <input type="hidden" id="email_client" name="email_client"
                                                    value="{{ $user->email }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            ">
                                                ...
                                                <input type="hidden" id="contact_client" name="contact_client"
                                                    value="{{ $user->contact }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        ...
                                        <input type="hidden" id="adresse_client" name="adresse_client"
                                            value="{{ $user->adresse }}">
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="colis[0][produit]"
                                                        required
                                                        style="border-radius: 10px; height: 45px; border: 1px solid #e9ecef;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" name="colis[0][valeur]"
                                                        step="0.01" min="0" required
                                                        style="border-radius: 10px; height: 45px; border: 1px solid #e9ecef;">
                                                </div>

                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold" style="color: #0e914b;">Type de
                                                        Colis</label>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-4">
                                                    <label class="form-label fw-bold" style="color: #0e914b;">Longueur
                                                        (cm)</label>
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label fw-bold" style="color: #0e914b;">Largeur
                                                        (cm)</label>
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label fw-bold" style="color: #0e914b;">Hauteur
                                                        (cm)</label>
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold"
                                                        style="color: #0e914b;">Description</label>
                                                    <textarea class="form-control" name="colis[0][description]" rows="2"
                                                        style="border-radius: 10px; border: 1px solid #e9ecef; height: 50px;" placeholder="Description du produit..."></textarea>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold" style="color: #0e914b;">Photo du
                                                        Colis</label>
                                                    <input type="file" class="form-control" name="colis[0][photo]"
                                                        accept="image/*"
                                                        style="border-radius: 10px; height: 50px; border: 1px solid #e9ecef;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <strong>Pays d'expédition:</strong> <span
                                                        id="recap_pays_expedition"></span>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <strong>Agence d'expédition:</strong> <span
                                                        id="recap_agence_expedition"></span>
                                                </div>
                                                <div class="col-md-6">
                                                    <strong>Agence de destination:</strong> <span
                                                        id="recap_agence_destination"></span>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <strong>Devise d'expédition:</strong> <span
                                                        id="recap_devise_expedition" class="badge bg-success"></span>
                                                </div>
                                                <div class="col-md-6">
                                                    <strong>Devise de destination:</strong> <span
                                                        id="recap_devise_destination" class="badge bg-info"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <h6 class="text-primary fw-bold" style="color: #0e914b;">
                                                ...
                                                <small class="text-muted">(Devise: <span
                                                        id="recap_devise_colis"></span>)</small>
                                            </h6>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateRecap() {
                ...
                if (agencesData[agenceExpeditionName]) {
                    document.getElementById('recap_devise_expedition').textContent = agencesData[
                        agenceExpeditionName].devise;
                }
                if (agencesData[agenceDestinationName]) {
                    document.getElementById('recap_devise_destination').textContent = agencesData[
                        agenceDestinationName].devise;
                }

                document.getElementById('recap_name_client').textContent = document.getElementById('name_client')
                    .value;
                document.getElementById('recap_prenom_client').textContent = document.getElementById(
                    'prenom_client').value;
                document.getElementById('recap_email_client').textContent = document.getElementById('email_client')
                    .value;
                document.getElementById('recap_contact_client').textContent = document.getElementById(
                    'contact_client').value;
                document.getElementById('recap_adresse_client').textContent = document.getElementById(
                ...
                document.querySelectorAll('.colis-item').forEach((item, index) => {
                    ...
                    const typeColis = item.querySelector(`select[name="colis[${index}][type_colis]"]`)
                    .value;
                    const description = item.querySelector(`textarea[name="colis[${index}][description]"]`)
                        .value;
                    ...
                    const photoInput = item.querySelector(`input[name="colis[${index}][photo]"]`);
                    let photoUrl = '';
                ...
                <div class="border rounded p-3 mb-3" style="border-left: 4px solid #fea219 !important;">
                    ...
                    ${longueur || largeur || hauteur ? `
                        <div class="row mt-2">
                            ...
                            <div class="col-md-4"><strong>Description:</strong> ${description || 'Aucune'}</div>
                            <div class="col-md-4">
                                <strong>Photo:</strong>
                                ${photoUrl ? `<div class="mt-1"><img src="${photoUrl}" style="max-height: 80px; max-width: 100%; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);" /></div>` : 'Aucune'}
                            </div>
                        </div>
                        ` : `
                        <div class="row mt-2">
