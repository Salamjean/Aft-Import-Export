        ...
        <div class="col-12">
            <div class="card modern-card">
                <div class="card-header modern-header">
                    ...
                    <div>
                        <a href="{{ route('agent.cote.bateau.index') }}" class="btn modern-btn text-white" style="background-color:#6c757d">
                            <i class="fas fa-arrow-left"></i>
                            Retour
                        </a>
                         <button class="btn modern-btn text-white" style="background-color:#0e914b" onclick="generateConteneurPDF({{ $conteneur->id }})">
