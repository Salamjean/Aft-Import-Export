            ...
            <div class="col-12">
                <div class="card modern-card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('agent.cote.colis.index') }}" class="table-controls">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <div class="filter-group">
                                        ...
                                        <a href="{{ route('agent.cote.colis.index') }}" class="btn btn-secondary">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="action-buttons">
                                                    ...
                                                    {{-- <a href="{{ route('agent.cote.colis.edit', $item->id) }}"
