                        ...
                        <div class="col-12">
                            <div class="action-section">
                                <div class="action-buttons">
                                    <a href="{{ route('agent.cote.bateau.index') }}" class="btn action-btn btn-back">
                                        <i class="fas fa-arrow-left me-2"></i>Retour à la liste
                                    </a>
                                    <a href="{{ route('agent.cote.colis.show', $bateau->conteneur->id) }}" class="btn action-btn btn-open">
