      ...
      <div class="menu-button-container menu-profile d-none d-md-block">
        <button class="mdc-button mdc-menu-button">
          <span class="d-flex align-items-center">
            ...
            <span class="user-name text-white"> {{Auth::guard('agent')->user()->name}} {{Auth::guard('agent')->user()->prenom}}</span>
        ...
        <div class="mdc-menu mdc-menu-surface" tabindex="-1">
          <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
            <li class="mdc-list-item" role="menuitem">
              <a href="{{route('agent.logout')}}" class="d-flex align-items-center w-100 text-decoration-none text-dark">
          ...
          <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
            <li class="mobile-user-info mdc-list-item" style="pointer-events: none;">
              <div class="d-flex align-items-center w-100">
                ...
                <span class="user-name">{{Auth::guard('agent')->user()->name}} {{Auth::guard('agent')->user()->prenom}}</span>
              </div>
            </li>
            <li role="separator" class="mdc-list-divider"></li>
            <li class="mdc-list-item" role="menuitem">
              <a href="{{route('agent.logout')}}" class="d-flex align-items-center w-100 text-decoration-none text-dark py-2">
                <i class="mdi mdi-logout mr-2" style="color: #193561; font-size: 1.5rem;"></i>
                <span>Déconnexion</span>
              </a>
            </li> 
