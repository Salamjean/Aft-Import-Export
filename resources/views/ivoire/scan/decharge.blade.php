        ...
        <div class="col-12">
            <div class="card modern-card">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('ivoire.scan.decharge') }}" class="table-controls">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <div class="filter-group">
                                    ...
                                    <a href="{{ route('ivoire.scan.decharge') }}" class="btn btn-secondary">
...
function processScannedCodeDecharge(qrCode, agenceId) {
    ...
    const url = '/agent/ivory/scan-qr-decharge';
