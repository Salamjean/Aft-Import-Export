...
<div class="container-fluid">
    ...
    <div class="row mb-4 mt-4">
        <div class="col-12">
            <div class="page-header bg-gradient-primary rounded-3 p-4 shadow" style="background: linear-gradient(135deg, #fea219, #fea219) !important;">
                            ...
                            <tbody>
                                @forelse($livraisons as $livraison)
                                    <tr class="livraison-row" 
                                        data-chauffeur="{{ $livraison->chauffeur_id }}" 
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    @if($livraison->quantite > 1)
                                                        <small class="text-muted">{{ $livraison->quantite }} articles</small>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span>
                                                    @if($livraison->chauffeur)
                                                        {{ $livraison->chauffeur->name }} {{ $livraison->chauffeur->prenom }}
                                                    @else
                                        ...
                                        <td style="text-align: center">
                                            <span class="badge bg-light text-dark border">{{ $livraison->nature_objet }}</span>
                                        </td>
                                        <td style="text-align: center">
                                            <span class="quantity-badge">{{ $livraison->quantite }}</span>
                                        </td>
                                        <td style="text-align: center">
                                            <strong>{{ $livraison->nom_concerne }} {{ $livraison->prenom_concerne }}</strong>
                                            <br><small class="text-muted">{{ Str::limit($livraison->adresse_depot, 30) }}</small>
                                        </td>
                                        <td style="text-align: center">
                                            <div>
                                        ...
                                        <td style="text-align: center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <button class="btn btn-sm btn-outline-primary btn-action" 
                                                        onclick="showDetails({{ $livraison->id }})" 
                                                        title="Détails">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-warning btn-action" 
                                                        onclick="editLivraison({{ $livraison->id }})" 
                                                        title="Modifier">
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center py-5">
                                            <div class="empty-state">
                                                ...
                                                <p class="text-muted">Commencez par créer votre premier programme de livraison</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
