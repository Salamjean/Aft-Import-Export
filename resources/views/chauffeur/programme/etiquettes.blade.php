...
<head>
    <meta charset="UTF-8">
    <title>Étiquette Dépôt - {{ $programme->reference }}</title>
    <style>
        * {
    ...
    <div class="etiquette">
        ...
        <div class="info-section">
            <div class="info-row">
                ...
                <div class="info-value">{{ $programme->reference }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">Nature:</div>
                <div class="info-value">{{ $programme->nature_objet }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">Destinataire:</div>
                <div class="info-value">{{ $programme->nom_concerne }} {{ $programme->prenom_concerne }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">Contact:</div>
                <div class="info-value">{{ $programme->contact }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">Adresse:</div>
                <div class="info-value" style="font-size:5pt;">{{ Str::limit($programme->adresse_programme, 45) }}</div> <!-- Réduit et augmenté la limite -->
            </div>
            <div class="info-row">
                <div class="info-label">Chauffeur:</div>
                <div class="info-value">{{ $programme->chauffeur->nom }} {{ $programme->chauffeur->prenom }}</div>
            </div>
            @if($programme->date_programme)
            <div class="info-row">
                <div class="info-label">Date dépôt:</div>
                <div class="info-value">{{ $programme->date_programme }}</div>
            </div>
            @endif
        </div>
