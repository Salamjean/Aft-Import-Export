...
<body>
    <form class="form-container animate__animated animate__fadeIn" method="POST" action="{{ route('chauffeur.handleLogin') }}">
        <div class="form-header">
           <img src="{{ asset('images/LOGOAFT.png') }}" class="auth-logo floating" alt="Logo" style="height:80px"><br>
            <p class="subtitle">Entrez vos identifiants pour accéder à l'espace</p>
        </div>
