    ...
    <div class="mdc-top-app-bar__section mdc-top-app-bar__section--align-end mdc-top-app-bar__section-right">
      ...
      <div class="menu-button-container menu-profile d-none d-md-block">
        <button class="mdc-button mdc-menu-button">
          <span class="d-flex align-items-center">
            <span class="figure">
              <img src="{{asset('assets/img/aft.jpg')}}" alt="user" class="user">
            </span>
            <span class="user-name text-white"> {{Auth::guard('chauffeur')->user()->name}} {{Auth::guard('chauffeur')->user()->prenom}}</span>
        ...
        <div class="mdc-menu mdc-menu-surface" tabindex="-1">
          <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
            <li class="mdc-list-item" role="menuitem">
              <a href="{{route('chauffeur.logout')}}" class="d-flex align-items-center w-100 text-decoration-none text-dark">
      ...
      <div class="d-md-none mobile-menu-container">
        <button class="mdc-icon-button text-white mobile-profile-toggle">
          <span class="figure">
            <img src="{{asset('assets/img/aft.jpg')}}" alt="user" class="user-mobile">
          </span>
        </button>
            ...
            <li class="mobile-user-info mdc-list-item" style="pointer-events: none;">
              <div class="d-flex align-items-center w-100">
                <span class="figure mr-2">
                  <img src="{{asset('assets/img/aft.jpg')}}" alt="user" class="user-mobile-small">
                </span>
                <span class="user-name">{{Auth::guard('chauffeur')->user()->name}} {{Auth::guard('chauffeur')->user()->prenom}}</span>
              </div>
            </li>
            <li role="separator" class="mdc-list-divider"></li>
            <li class="mdc-list-item" role="menuitem">
              <a href="{{route('chauffeur.logout')}}" class="d-flex align-items-center w-100 text-decoration-none text-dark py-2">
                <i class="mdi mdi-logout mr-2" style="color: #193561; font-size: 1.5rem;"></i>
                <span>Déconnexion</span>
              </a>
            </li> 
