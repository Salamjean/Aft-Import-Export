            ...
            <div class="card modern-card">
                <div class="card-header modern-header">
                    ...
                    <div class="header-actions">
                        <button onclick="openQRScannerDecharge()" class="btn modern-btn text-white" style="background-color:#17a2b8; margin-right: 10px;">
                            <i class="fas fa-qrcode"></i>
                            Scanner pour Déchargement
                        </button>
                        <a href="{{ route('agent.scan.charge') }}" class="btn modern-btn" style="background-color:#6c757d;">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="progress mt-2" style="height: 20px;">
                                            <div class="progress-bar bg-primary" role="progressbar" 
                                                 ...
                                                 aria-valuenow="{{ $pourcentageDecharge }}" 
                                                 aria-valuemin="0" 
                                                 aria-valuemax="100">
