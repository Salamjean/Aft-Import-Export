...
@section('content')
    ...
    <div class="bilan-financier-container">
        ...
        <div class="bilan-header">
            <div class="header-left d-flex align-items-center gap-4">
                ...
                <div>
                    <h1 class="header-title">Encaissements de l'Agence</h1>
                    <p class="header-subtitle text-muted">Historique complet des transactions financières de votre site</p>
                </div>
            </div>
            ...
            <div class="analytics-card border-0 shadow-lg">
                <div class="card-header-modern mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0 ms-3 font-weight-bold">Journal des flux financiers</h5>
                    </div>
                </div>
    ...
    <style>
        ...
        .amount-text { font-family: 'Outfit', sans-serif; font-size: 16px; font-weight: 800; color: #10b981; }
