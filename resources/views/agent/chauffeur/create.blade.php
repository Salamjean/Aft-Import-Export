    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-12 col-xl-12">
            ...
            <div class="card shadow-sm mb-5">
                ...
                <div class="card-body">
                    <form action="{{ route('agent.chauffeur.store') }}" method="POST" id="chauffeurForm">
                        @csrf
                                    ...
                                    <tr id="chauffeur-{{ $chauffeur->id }}">
                                        ...
                                        <td class="py-3 px-4 text-center">
                                            <div class="btn-group" role="group">
                                                ...
                                                <form action="{{ route('agent.chauffeur.destroy', $chauffeur->id) }}" 
        ...
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                   ...
                   fetch(`{{ route('agent.chauffeur.update', ':id') }}`.replace(':id', chauffeurId), {
                        method: 'POST',
                        body: formData,
                        headers: {
