                ...
                <div class="card modern-card">
                    <div class="card-header modern-header">
                        ...
                        <div class="header-actions">
                            <button onclick="downloadAllColisPDF()" class="btn modern-btn text-white"
                                style="background-color:#dc3545; margin-right: 10px;">
                                <i class="fas fa-file-pdf"></i>
                                Télécharger PDF
                            </button>
                            <a href="{{ route('colis.create') }}" class="btn modern-btn text-white"
                                style="background-color:#0e914b">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('agent.colis.history') }}" class="table-controls">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="filter-group">
                                        <select class="form-control modern-select" name="status">
                                            ...
                                            <option value="valide" {{ request('statut') == 'valide' ? 'selected' : '' }}>
                                                Validé</option>
                                            <option value="charge" {{ request('statut') == 'charge' ? 'selected' : '' }}>
                                                Chargé</option>
                                            <option value="entrepot" {{ request('statut') == 'entrepot' ? 'selected' : '' }}>
                                                En Entrepôt</option>
                                            <option value="decharge" {{ request('statut') == 'decharge' ? 'selected' : '' }}>
                                                Déchargé</option>
                                            <option value="livre" {{ request('statut') == 'livre' ? 'selected' : '' }}>Livré
                                            </option>
                                        </select>
                                        ...
                                        <a href="{{ route('agent.colis.history') }}" class="btn btn-secondary">
                                            ...
                                            {{-- <td class="text-center">
                                                <div class="action-buttons">
                                                    ...
                                                    <button
                                                        ...
                                                        onclick="showPaymentForm({{ $item->id }}, '{{ $item->reference_colis
                                                        }}', {{ $item->montant_total }}, {{ $item->montant_paye }}, {{
                                                        $item->reste_a_payer ?? 0 }}, '{{ $item->devise }}')"
                                                        @else
                                                        disabled
                                                        @endif
                                                        title="{{ $item->statut_paiement == 'totalement_paye' ? 'Paiement
                                                        complet' : 'Enregistrer un paiement' }}">
