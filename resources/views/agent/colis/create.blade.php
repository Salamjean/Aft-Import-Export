                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <p class="mb-0 text-black">
                                                <strong>Nom:</strong> <span
                                                    id="current_conteneur_name">{{ $conteneur->name_conteneur }}</span> |
                                                <strong>Type:</strong> <span
                                                    id="current_conteneur_type">{{ $conteneur->type_conteneur }}</span> |
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div
                                                ...
                                                <strong id="agence_expedition_display"
                                                    class="fs-6">{{ $agenceExpedition->name ?? 'Louis Blériot' }}</strong>
                                                <small
                                                    class="text-muted mt-1">{{ $agenceExpedition->pays ?? 'France' }}</small>
                                            </div>
                                            <input type="hidden" id="agence_expedition_id" name="agence_expedition_id"
                                                value="{{ $agenceExpedition->id ?? '' }}">
                                        </div>
                                    </div>
