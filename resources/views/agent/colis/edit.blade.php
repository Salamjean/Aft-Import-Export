...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card modern-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress-container mb-4">
                            <div class="progress" style="height: 8px; border-radius: 10px; background-color: #f8f9fa;">
                                <div class="progress-bar" role="progressbar"
                                    style="width: 14.28%; border-radius: 10px; background: linear-gradient(135deg, #fea219 0%, #e69100 100%);"
                                    id="progress-bar"></div>
                            </div>
                        </div>
                        ...
                        <div class="conteneur-info-card mb-4" id="conteneur_info_section">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            ...
                                            <div id="conteneur_details">
                                                <p class="mb-0 text-black">
                                                    <strong>Nom:</strong>
                                                    {{ $colis->conteneur->name_conteneur ?? 'Non spécifié' }} |
                                                    <strong>Type:</strong>
                                                    {{ $colis->conteneur->type_conteneur ?? 'Non spécifié' }} |
                                                    <strong>Statut:</strong>
                                                    <span
                                                        class="badge bg-success text-white">{{ $colis->conteneur->statut ?? 'Actif' }}</span>
                                                </p>
                                        ...
                                        <div class="col-md-4 text-end">
                                            <!-- AFFICHAGE DE LA RÉFÉRENCE (NON MODIFIABLE) -->
                                            <div class="reference-display">
                                                <small class="text-muted d-block">Référence du colis</small>
                                                <span class="badge fs-6 text-white" id="reference_display"
                                                    style="background-color: #0e914b; font-size: 20px; cursor: not-allowed;">
                                                    {{ $colis->reference_colis }}
                                                </span>
                                                <small class="text-muted d-block mt-1">
                                                    <i class="fas fa-lock me-1"></i>Non modifiable
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form action="{{ route('agent.colis.update', $colis->id) }}" method="POST" class="modern-form"
                            id="colisForm">
                            @csrf
                            @method('PUT')

                            <!-- Champs cachés -->
                            <input type="hidden" name="conteneur_id" value="{{ $colis->conteneur_id }}"
                                id="conteneur_id_input">
                            <input type="hidden" name="reference_colis" value="{{ $colis->reference_colis }}"
                            ...
                            <div class="step-content" id="step-1">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="agence_destination" class="form-label required">Agence de
                                                Destination</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light border-end-0">
                                                ...
                                                <input type="text" class=" border-start-0 modern-input"
                                                    id="agence_destination" name="agence_destination" readonly required
                                            ...
                                            <input type="hidden" id="agence_destination_id" name="agence_destination_id"
                                                value="{{ $colis->agence_destination_id }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="agence_expedition_id" class="form-label required">Agence
                                                d'Expédition</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light border-end-0">
                                                    <i class="fas fa-plane-departure" style="color: #fea219;"></i>
                                                </span>
                                                <select class="border-start-0 modern-select" id="agence_expedition_id"
                                                    name="agence_expedition_id" required disabled
                                            ...
                                            <small class="text-muted mt-1">
                                                <i class="fas fa-lock me-1"></i>Agence non modifiable en édition
                                            </small>
                                            <!-- Champ caché pour envoyer la valeur au serveur -->
                                            <input type="hidden" name="agence_expedition_id"
                                                value="{{ $colis->agence_expedition_id }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div
                                                class="info-field bg-light rounded p-3 text-center h-100 d-flex flex-column justify-content-center">
                                                <strong id="devise_expedition_display"
                                                    class="fs-5">{{ $colis->devise }}</strong>
                            ...
                            <div class="step-content d-none" id="step-2">
                                <div class="step-header mb-4 text-center">
                                    ...
                                    <p class="text-muted">Sélectionnez le type d'expéditeur et renseignez les informations
                                    </p>
                                </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="type_expediteur" class="form-label required">Type
                                                d'Expéditeur</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light border-end-0">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="text-muted">La sélection pré-remplira automatiquement les
                                                champs</small>
                                        </div>
                                    </div>
                                    <input type="hidden" name="user_id" id="user_id" value="{{ $colis->user_id }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="modern-input" id="name_expediteur"
                                                name="name_expediteur" value="{{ $colis->name_expediteur }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3" id="prenom_field">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="modern-input" id="prenom_expediteur"
                                                name="prenom_expediteur" value="{{ $colis->prenom_expediteur }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="modern-input" id="email_expediteur"
                                                name="email_expediteur" value="{{ $colis->email_expediteur }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="modern-input" id="prenom_destinataire"
                                                name="prenom_destinataire" value="{{ $colis->prenom_destinataire }}"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="modern-input" id="email_destinataire"
                                                name="email_destinataire" value="{{ $colis->email_destinataire }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="modern-select" id="indicatif" name="indicatif" required>
                                                ...
                                                <option value="+33" {{ $colis->indicatif == '+33' ? 'selected' : '' }}>
                                                    +33 (France)</option>
                                                <option value="+86" {{ $colis->indicatif == '+86' ? 'selected' : '' }}>
                                                    +86 (Chine)</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="modern-input" id="contact_destinataire"
                                                name="contact_destinataire" value="{{ $colis->contact_destinataire }}"
                                                required>
                                        </div>
                                    </div>
                            ...
                            <div class="step-content d-none" id="step-4">
                                ...
                                <div class="calcul-auto-info d-none" id="info-calcul-auto">
                                    ...
                                    <strong>Calcul automatique :</strong> En mode aérien, le prix est calculé
                                    automatiquement à raison de
                                    <strong id="prix-kg-display">15 EUR par kg</strong>. Le prix sera converti en XOF si
                                    nécessaire.
                                </div>
                                    ...
                                    @foreach ($colisData as $index => $item)
                                        <div class="colis-item card mb-4 border-0 shadow-sm"
                                            ...
                                            <div class="card-body">
                                                <div class="row g-3">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            name="colis[{{ $index }}][quantite]" min="1"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="search-container position-relative">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control border-start-0 produit-input"
                                                        ...
                                                        <small class="text-muted">Commencez à taper pour rechercher un
                                                            produit</small>
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <input type="hidden" class="type-calcul-input"
                                                    name="colis[{{ $index }}][type_calcul]"
                                                    value="{{ $item['type_calcul'] ?? 'manuel' }}">
                                        ...
                                        <div class="mt-4 p-3 bg-light rounded">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <span
                                                        id="montant_colis_display">{{ number_format($colis->montant_colis, 2) }}</span>
                                                    <span id="devise_colis_display"
                                                        class="devise-dynamic">{{ $colis->devise }}</span>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-6">
                                                ...
                                                <div class="col-6 text-end">
                                                    <span
                                                        id="montant_service_display">{{ number_format($colis->prix_service ?? 0, 2) }}</span>
                                                    <span id="devise_service_display"
                                                        class="devise-dynamic">{{ $colis->devise }}</span>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <span id="montant_total_display"
                                                        class="fw-bold">{{ number_format($colis->montant_total, 2) }}</span>
                                                    <span id="devise_total_display"
                                                        class="devise-dynamic">{{ $colis->devise }}</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="step-content d-none" id="step-6">
                                <div class="step-header mb-4 text-center">
                                    ...
                                    <p class="text-muted">Sélectionnez la méthode de paiement et renseignez les
                                        informations</p>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="methode_paiement" class="form-label required">Méthode de
                                                Paiement</label>
                                        ...
                                        <div id="paiement-fields">
                                            @php
                                                $paiementData = [
                                                    'nom_banque' => $colis->nom_banque,
                                                    'numero_compte' => $colis->numero_compte,
                                                    'operateur_mobile_money' => $colis->operateur_mobile_money,
                                                    'numero_mobile_money' => $colis->numero_mobile_money,
                                                ];
                                            @endphp
                                            ...
                                            @elseif($colis->methode_paiement == 'mobile_money')
                                                <div class="paiement-method-fields">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label required">Numéro de
                                                                    Téléphone</label>
                                                                <input type="text" class="modern-input"
                                            ...
                                            @elseif($colis->methode_paiement == 'livraison')
                                                <div class="paiement-method-fields">
                                                    <div class="alert alert-info">
                                                        <i class="fas fa-info-circle me-2"></i>
                                                        Le paiement sera effectué à la livraison du colis. Le montant payé
                                                        sera de 0.
                                                    </div>
                                            ...
                                            @else
                                                <div class="paiement-method-fields">
                                                    <div class="alert alert-info">
                                                        <i class="fas fa-info-circle me-2"></i>
                                                        Le montant payé sera enregistré dans le champ "Montant Payé"
                                                        ci-dessous.
                                                    </div>
                                                </div>
                                            @endif
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="montant_paye" class="form-label required">Montant
                                                        Payé</label>
                                                    <input type="number" class="modern-input" id="montant_paye"
                                                        name="montant_paye" step="0.01" min="0"
                                                        value="{{ $colis->montant_paye }}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="reste_a_payer" class="form-label">Reste à Payer</label>
                                                    <input type="number" class="modern-input" id="reste_a_payer"
                                                        name="reste_a_payer" readonly step="0.01" min="0"
                                                        value="{{ $colis->reste_a_payer }}">
                                                </div>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="statut_paiement" class="form-label required">Statut du
                                                Paiement</label>
                            ...
                            <div class="step-content d-none" id="step-7">
                                <div class="step-header mb-4 text-center">
                                    ...
                                    <p class="text-muted">Vérifiez toutes les informations avant de finaliser la
                                        modification</p>
                                </div>
                                ...
                                <div class="recap-container">
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-borderless recap-table">
                                                        <tr>
                                                            ...
                                                            <td id="recap_expediteur_nom">{{ $colis->name_expediteur }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="card recap-card mb-4">
                                        <div
                                            class="card-header recap-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <i class="fas fa-boxes me-2"></i>
                                                Détails des Colis
                                            </h5>
                                            <span class="badge bg-primary fs-6"
                                                id="recap_nombre_colis">{{ count($colisData) }} colis</span>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <tbody id="recap_colis_body">
                                                        ...
                                                        @foreach ($colisData as $index => $item)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="fw-bold">{{ number_format($totalColis, 2) }}
                                                                </td>
                                                                <td>{{ $item['type_colis'] ?? 'Standard' }}</td>
                                                                <td>{{ $dimensions }}</td>
                                                                <td>{{ $item['poids'] ?? false ? $item['poids'] . ' kg' : '-' }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-borderless recap-table">
                                                        <tr>
                                                            ...
                                                            <td id="recap_methode_paiement">
                                                                @if ($colis->methode_paiement == 'espece')
                                                                    Espèce
                                                                @elseif($colis->methode_paiement == 'virement_bancaire')
                                                                    Virement Bancaire
                                                                @elseif($colis->methode_paiement == 'cheque')
                                                                    Chèque
                                                                @elseif($colis->methode_paiement == 'mobile_money')
                                                                    Mobile Money
                                                                @elseif($colis->methode_paiement == 'livraison')
                                                            ...
                                                            <td>
                                                                ...
                                                                @else bg-secondary @endif"
                                                                    ...
                                                                    @elseif($colis->statut_paiement == 'partiellement_paye')
                                                                        Partiellement Payé
                                                                    @elseif($colis->statut_paiement == 'totalement_paye')
                                                                        Totalement Payé
                                                                    @else
                                                                        -
                                                                    @endif
                            ...
                            <input type="hidden" name="montant_colis" id="montant_colis_input"
                                value="{{ $colis->montant_colis }}">
                            <input type="hidden" name="montant_total" id="montant_total_input"
                                value="{{ $colis->montant_total }}">
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Constantes pour le calcul automatique
    ...
    `
            ...
            document.getElementById('agence_expedition_id').addEventListener('change', function() {
                ...
                updateConteneurEtReference();
                setTimeout(() => {
                    if (document.getElementById('mode_transit').value === 'Aerien') {
                        updateTypeCalcul();
                        updatePrixKgDisplay();
                        // Recalculer tous les prix en mode aérien
            ...
            document.getElementById('colisForm').addEventListener('submit', function(e) {
                ...
                submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Modification...';

                // La soumission se poursuit normalement
                console.log('=== FIN MODIFICATION FORMULAIRE ===');
            });

            function updateAgenceDestination() {
                // NE RIEN FAIRE en mode édition - garder la valeur originale
                console.log('Mode édition - Agence de destination non modifiable');
            }

            function updateDeviseExpedition() {
                // Garder la devise originale
                const devise = '{{ $colis->devise }}';
                document.getElementById('devise_expedition_display').textContent = devise;
                document.getElementById('devise_expedition_info').textContent = 'Devise originale du colis';
                document.getElementById('devise').value = devise;

                updateAllDevises(devise);
            }

            async function updateConteneurEtReference() {
                // NE RIEN FAIRE en mode édition - garder les valeurs originales
                console.log('Mode édition - Conteneur et référence non modifiables');

                // Afficher quand même les informations du conteneur actuel
                document.getElementById('conteneur_info_section').style.display = 'block';
                document.getElementById('conteneur_info_message').style.display = 'none';

                // Afficher les informations du conteneur existant
        ...
        `;
            ...
            function updateConteneurInfo(conteneur) {
                const conteneurDetails = document.getElementById('conteneur_details');
        ...
        `;
            ...
            function updateDeviseExpeditionDisplay(devise) {
                document.getElementById('devise_expedition_display').textContent = devise;
            ...
            function updateMontants() {
                ...
                document.querySelectorAll('.colis-item').forEach(item => {
                    ...
                    // MODIFICATION : En mode aérien, on ne multiplie pas par la quantité
                    // En mode maritime, on multiplie par la quantité
                    if (modeTransit === 'Aerien') {
                        montantColis += prixUnitaire; // Prix total pour le colis (déjà calculé par poids)
                    } else {
                        montantColis += quantite * prixUnitaire; // Prix × quantité pour le maritime
                    }
                });
            ...
            // Fonction pour mettre à jour le type de calcul basé sur le mode de transit
            function updateTypeCalcul() {
                const modeTransit = document.getElementById('mode_transit').value;
                const typeCalcul = modeTransit === 'Aerien' ? 'auto_poids' : 'manuel';

                document.querySelectorAll('.colis-item').forEach(item => {
                    const typeCalculInput = item.querySelector('.type-calcul-input');
                    const prixUnitaireInput = item.querySelector('.prix-unitaire-input');
                    const poidsInput = item.querySelector('input[name*="[poids]"]');

                    if (typeCalculInput) {
                        typeCalculInput.value = typeCalcul;
                    }
            ...
            // Fonction pour calculer le prix automatiquement basé sur le poids
            function calculerPrixAuto(poidsInput) {
                const colisItem = poidsInput.closest('.colis-item');
                const index = colisItem.dataset.index;
            ...
            // Fonction pour gérer l'affichage du message d'information
            function toggleInfoCalculAuto() {
                const modeTransit = document.getElementById('mode_transit').value;
                const infoDiv = document.getElementById('info-calcul-auto');
            ...
            function updatePrixKgDisplay() {
                ...
                if (modeTransit === 'Aerien') {
                    if (devise === 'EUR') {
                        prixKgDisplay.textContent = '15 EUR par kg (prix forfaitaire par colis)';
                    } else {
                        prixKgDisplay.textContent =
                            `${(15 * TAUX_CONVERSION_EURO_XOF).toFixed(0)} XOF par kg (prix forfaitaire par colis)`;
                    }
                }
            }
            document.getElementById('mode_transit').addEventListener('change', function() {
            ...
            function addColis() {
                ...
                const typeCalculInput = document.createElement('input');
                typeCalculInput.type = 'hidden';
                typeCalculInput.className = 'type-calcul-input';
                typeCalculInput.name = `colis[${colisCount}][type_calcul]`;
                typeCalculInput.value = document.getElementById('mode_transit').value === 'Aerien' ? 'auto_poids' :
                    'manuel';
                newColis.appendChild(typeCalculInput);
            ...
            function updateAllDevises(devise) {
                ...
                document.querySelectorAll('#service_id option').forEach(option => {
                    if (option.textContent.includes(' - ')) {
                        ...
                        if (parts.length >= 2) {
                            const prixPart = parts[1].split(' ')[0];
            ...
            function updateRecap() {
                const modeTransit = document.getElementById('mode_transit').value;
                const agenceExpeditionSelect = document.getElementById('agence_expedition_id');
                const agenceExpedition = agenceExpeditionSelect.options[agenceExpeditionSelect.selectedIndex]
                    ?.textContent || '-';
                const agenceDestination = document.getElementById('agence_destination').value;
                const devise = document.getElementById('devise').value;
                const reference = '{{ $colis->reference_colis }}'; // Référence fixe

                const conteneurDetails = document.getElementById('conteneur_details');
                let conteneur = '-';
                if (conteneurDetails) {
                    const detailsText = conteneurDetails.textContent || '';
                    const nomMatch = detailsText.match(/Nom:\s*([^|]+)/);
                    conteneur = nomMatch ? nomMatch[1].trim() : 'Conteneur actif';
                }
                ...
                // Montants
                const montantColisDisplay = document.getElementById('montant_colis_display').textContent;
                const montantTotalDisplay = document.getElementById('montant_total_display').textContent;
                ...
                document.getElementById('recap_destinataire_contact').textContent = contactDestinataire || '-';
                ...
                document.getElementById('recap_methode_paiement').textContent = getMethodePaiementText(
                    methodePaiement);
                document.getElementById('recap_montant_total').textContent = (parseFloat(montantTotalDisplay) || 0)
                    .toFixed(2) + ' ' + devise;
            ...
            function updateColisTable() {
                ...
                document.querySelectorAll('.colis-item').forEach((item, index) => {
                    const quantiteInput = item.querySelector(`[name="colis[${index}][quantite]"]`);
                    const produitInput = item.querySelector(`[name="colis[${index}][produit]"]`);
                    const prixUnitaireInput = item.querySelector(`[name="colis[${index}][prix_unitaire]"]`);
                    const longueurInput = item.querySelector(`[name="colis[${index}][longueur]"]`);
                    const largeurInput = item.querySelector(`[name="colis[${index}][largeur]"]`);
                    const hauteurInput = item.querySelector(`[name="colis[${index}][hauteur]"]`);
                    const poidsInput = item.querySelector(`[name="colis[${index}][poids]"]`);
                    ...
                    const longueur = longueurInput?.value || '-';
                ...
                const recapTotalColis = document.getElementById('recap_total_colis');
                const recapNombreColis = document.getElementById('recap_nombre_colis');

                if (recapTotalColis) {
                    recapTotalColis.textContent = totalGeneral.toFixed(2) + ' ' + devise;
                }

                if (recapNombreColis) {
                    recapNombreColis.textContent = nombreColis + ' colis' + (nombreColis > 1 ? 's' : '');
                }
            }
            ...
            function validateStep(step) {
                ...
                if (step === 2) {
                    ...
                    if (!nameExpediteur || !contactExpediteur) {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Champs obligatoires',
                ...
                if (step === 3) {
                    ...
                    if (!nameDestinataire || !prenomDestinataire || !contactDestinataire) {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Champs obligatoires',
            ...
            function validateAllSteps() {
                const stepsToValidate = [1, 2, 3, 4, 6];
            ...
            // Initialiser le type de calcul au chargement
            setTimeout(() => {
                updateTypeCalcul();
                toggleInfoCalculAuto();
            }, 500);
        ...
        function initializeEditMode() {
            ...
            // Désactiver les fonctionnalités de mise à jour automatique
            document.getElementById('agence_expedition_id').disabled = true;

            // Forcer l'affichage des informations du conteneur
            updateConteneurEtReference();

            // Mettre à jour la devise avec la valeur originale
            updateDeviseExpedition();
