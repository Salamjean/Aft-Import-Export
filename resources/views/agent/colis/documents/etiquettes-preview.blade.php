...
<body>
    <div class="container">
        ...
        <div class="actions">
            <a href="/agent/parcel/{{ $colis->id }}/etiquettes?action=download" class="btn">
                Télécharger PDF
            </a>
            <a href="/agent/parcel/{{ $colis->id }}/etiquettes?action=print" class="btn">
                Imprimer
            </a>
            <a href="{{ route('agent.colis.index') }}" class="btn" style="background-color: #6c757d;">
                Retour à la liste
            </a>
        </div>
    </div>
