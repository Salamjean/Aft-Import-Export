      ...
      <nav class="mdc-list mdc-drawer-menu">
        ...
        <div class="mdc-list-item mdc-drawer-item">
          ...
          <div class="mdc-expansion-panel" id="ui-sub-finance">
            <nav class="mdc-list mdc-drawer-submenu">
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.bilan_financier.index')}}">
                  Bilan Agence
                </a>
              </div>
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.bilan_financier.historique')}}">
                  Mes Encaissements
                </a>
              </div>
            </nav>
        ...
        <div class="mdc-list-item mdc-drawer-item">
          ...
          <div class="mdc-expansion-panel" id="ui-sub-colis">
            <nav class="mdc-list mdc-drawer-submenu">
              ...
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.colis.index')}}">
                  Colis enregistré
                </a>
              </div>
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.colis.history')}}">
                  Historiques
                </a>
              </div>
            </nav>
        ...
        <div class="mdc-list-item mdc-drawer-item">
          ...
          <div class="mdc-expansion-panel" id="ui-sub-menu">
            <nav class="mdc-list mdc-drawer-submenu">
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.scan.entrepot')}}">
                  Mise en entrépot
                </a>
              </div>
              <div class="mdc-list-item mdc-drawer-item">
              ...
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.scan.decharge')}}">
                  Déchargment
                </a>
              </div>
            </nav>
        ...
        <div class="mdc-list-item mdc-drawer-item">
          ...
          <div class="mdc-expansion-panel" id="ui-sub-code">
            <nav class="mdc-list mdc-drawer-submenu">
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.bateau.planifier')}}">
                  Planifier
                </a>
              </div>
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.bateau.index')}}">
                  Liste
                </a>
              </div>
              {{-- <div class="mdc-list-item mdc-drawer-item">
        ...
        <div class="mdc-list-item mdc-drawer-item">
          <a class="mdc-drawer-link" href="{{route('agent.chauffeur.create')}}">
        ...
        <div class="mdc-list-item mdc-drawer-item">
          ...
          <div class="mdc-expansion-panel" id="ui-sub-pro">
            <nav class="mdc-list mdc-drawer-submenu">
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.programme.type')}}">
                  Planifier
                </a>
              </div>
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.programme.list')}}">
                  Liste
                </a>
              </div>
              {{-- <div class="mdc-list-item mdc-drawer-item">
        ...
        <div class="mdc-list-item mdc-drawer-item">
          ...
          <div class="mdc-expansion-panel" id="ui-sub-client">
            <nav class="mdc-list mdc-drawer-submenu">
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.client.all')}}">
                  Client
                </a>
              </div>
              <div class="mdc-list-item mdc-drawer-item">
                <a class="mdc-drawer-link" href="{{route('agent.prospect.all')}}">
                  Prospect
                </a>
              </div>
              {{-- <div class="mdc-list-item mdc-drawer-item">
        ...
        <div class="mdc-list-item mdc-drawer-item">
          <a class="mdc-drawer-link" href="javascript:void(0)" title="Bientôt disponible"
            style="color: #9e9e9e !important; cursor: not-allowed; opacity: 0.6;">
            <i class="fas fa-sms mdc-list-item__start-detail mdc-drawer-item-icon" style="color: #9e9e9e !important;"
              aria-hidden="true"></i>
            Envoi SMS
          </a>
        </div>
