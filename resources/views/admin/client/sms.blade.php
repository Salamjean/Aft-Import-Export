...
<div class="card card-modern mt-4">
    <div class="card-header card-header-modern">
        <h3 class="card-title"><i class="fas fa-sms me-2"></i>Envoi de SMS groupés</h3>
    </div>
    <div class="card-body p-4">
        <form action="{{ route('admin.sms.send-group') }}" method="POST" id="smsForm">
            @csrf
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-modern">
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.sms.send-prospect-group') }}" method="POST">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-6">
...
<form id="individualSmsForm" action="{{ route('admin.sms.send-individual') }}" method="POST" style="display: none;">
    @csrf
...
<form id="prospectIndividualSmsForm" action="{{ route('admin.sms.send-prospect-individual') }}" method="POST" style="display: none;">
    @csrf
