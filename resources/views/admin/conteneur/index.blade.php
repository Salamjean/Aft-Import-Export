        ...
        <div class="col-12">
            <div class="card modern-card">
                <div class="card-header modern-header">
                    ...
                    <a href="{{ route('conteneur.create') }}" class="btn modern-btn text-white" style="background-color:#0e914b ">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('conteneur.edit', $conteneur->id) }}" class="btn btn-action btn-edit" title="Modifier">
                                            ...
                                            <form action="{{ route('conteneur.destroy', $conteneur->id) }}" method="POST" class="d-inline delete-form">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <div class="action-buttons">
                                                <a href="{{ route('conteneur.colis.show', $conteneur->id) }}" class="btn btn-action btn-view" title="Ouvrir le conteneur">
...
function showDetails(id) {
    ...
    fetch(`/admin/container/${id}/details`)
        ...
        .then(data => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = `/admin/conteneur/${id}/edit`;
                }
            });
        })
        .catch(error => {
...
function closeConteneur(id) {
    fetch(`/admin/conteneur/${id}/close`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '{{ csrf_token() }}'
