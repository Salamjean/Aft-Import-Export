        ...
        <div class="col-md-10">
            <div class="card modern-card">
                <div class="card-header modern-header">
                    ...
                    <h3 class="card-title">Créer un nouveau conteneur</h3>
                    <p class="card-subtitle">Remplissez les informations du conteneur</p>
                </div>
                <div class="card-body">
                    <form action="{{ route('conteneur.store') }}" method="POST" class="modern-form">
                        @csrf
                        ...
                        <div class="row form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class=" modern-input" id="name_conteneur" name="name_conteneur" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class=" modern-input" id="numero_conteneur" name="numero_conteneur">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="agence_id" class="form-label required">Agence</label>
                                    <select class="modern-select" id="agence_id" name="agence_id" required>
                                        <option value="">Sélectionnez l'agence</option>
                                        <option value="1">AFT Agence Louis Bleriot</option>
                                        <option value="3"> Agence de Chine</option>
                                    </select>
                                </div>
                            </div>
                        </div>
