            ...
            <div class="card modern-card">
                <div class="card-header modern-header">
                    ...
                    <div class="header-actions">
                        <button onclick="openQRScannerCharge()" class="btn modern-btn text-white" style="background-color:#007bff; margin-right: 10px;">
                            <i class="fas fa-qrcode"></i>
                            Scanner pour Chargement
                        </button>
                        <a href="{{ route('scan.entrepot') }}" class="btn modern-btn" style="background-color:#6c757d;">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('scan.charge') }}" class="table-controls">
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="progress mt-2" style="height: 20px;">
                                            <div class="progress-bar bg-warning" role="progressbar" 
                                                 ...
                                                 aria-valuenow="{{ $pourcentageCharge }}" 
                                                 aria-valuemin="0" 
                                                 aria-valuemax="100">
                                    ...
                                    <td class="text-center">
                                        <div class="action-buttons">
                                            ...
                                            {{-- <button class="btn-action btn-labels" 
                                                    onclick="scanUniteCharge({{ $item->id }})" 
...
function processScannedCodeCharge(qrCode, conteneurId) {
    ...
    const url = '/admin/scan/scan-qr-charge';
