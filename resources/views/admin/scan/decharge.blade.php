            ...
            <div class="card modern-card">
                <div class="card-header modern-header">
                    ...
                    <div class="header-actions">
                        ...
                        <a href="{{ route('scan.charge') }}" class="btn modern-btn" style="background-color:#6c757d;">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('scan.decharge') }}" class="table-controls">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <div class="filter-group">
                                    ...
                                    <a href="{{ route('scan.decharge') }}" class="btn btn-secondary">
...
function processScannedCodeDecharge(qrCode, agenceId) {
    ...
    const url = '/admin/scan/scan-qr-decharge';
