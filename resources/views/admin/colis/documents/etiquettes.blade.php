            ...
            <div class="etiquette-page {{ $loop->last ? 'last-page' : '' }}">
                <div class="etiquette-content">
                    ...
                    <table class="info-header-table">
                        <tr>
                            <td class="logo-cell">
                                @if(file_exists(public_path('assets/img/aft.jpg')))
                                    <img src="{{ public_path('assets/img/aft.jpg') }}" class="custom-logo bw-logo" alt="Logo">
                                @else
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="exp-cell" style="text-align: center">
                                    <span>{{ $colisItem->name_expediteur }} {{ $colisItem->prenom_expediteur }}</span><br>
                                    <span class="sub-info">{{ $colisItem->contact_expediteur }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
