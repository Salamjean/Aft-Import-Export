                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-4 text-end">
                                            <span class="badge fs-6 text-white" id="reference_display"
                                                style="background-color: #0e914b;font-size:20px">{{ $reference }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('colis.store') }}" method="POST" class="modern-form" id="colisForm">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div
                                                ...
                                                <strong id="devise_expedition_display" class="fs-5">-</strong>
                                                <small class="text-muted mt-1" id="devise_expedition_info">Sélectionnez
                                                    une agence</small>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="modern-input" id="contact_expediteur"
                                                name="contact_expediteur" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="modern-input" id="name_destinataire"
                                                name="name_destinataire" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="modern-input" id="prenom_destinataire"
                                                name="prenom_destinataire" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="modern-input" id="contact_destinataire"
                                                name="contact_destinataire" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="number" class="form-control" name="colis[0][quantite]"
                                                        min="1" required>
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <input type="hidden" class="type-calcul-input" name="colis[0][type_calcul]"
                                                value="manuel">
                                            <div class="row g-3 mt-3">

                                                <div class="col-md-3">
                                                    <label class="form-label fw-bold">Longueur (cm)</label>
                                                    <input type="number" class="form-control" name="colis[0][longueur]"
                                                        step="0.1" min="0">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label fw-bold">Largeur (cm)</label>
                                                    <input type="number" class="form-control" name="colis[0][largeur]"
                                                        step="0.1" min="0">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label fw-bold">Hauteur (cm)</label>
                                                    <input type="number" class="form-control" name="colis[0][hauteur]"
                                                        step="0.1" min="0">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label fw-bold">Poids (kg)</label>
                                                    <input type="number" class="form-control" name="colis[0][poids]"
                                                        step="0.1" min="0">
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-4 p-3 bg-light rounded">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <span id="montant_colis_display">0</span> <span
                                                        id="devise_colis_display" class="devise-dynamic">XOF</span>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-6">
                                                ...
                                                <div class="col-6 text-end">
                                                    <span id="montant_service_display">0</span> <span
                                                        id="devise_service_display" class="devise-dynamic">XOF</span>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <span id="montant_total_display" class="fw-bold">0</span> <span
                                                        id="devise_total_display" class="devise-dynamic">XOF</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="modern-input" id="montant_paye"
                                                        name="montant_paye" step="0.01" min="0" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                            ...
                            <div class="step-content d-none" id="step-7">
                                <div class="step-header mb-4 text-center">
                                    ...
                                    <p class="text-muted">Vérifiez toutes les informations avant de finaliser
                                        l'enregistrement</p>
                                </div>
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-borderless recap-table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="badge" id="recap_statut_paiement">-</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
    ...
    `
            ...
            function updateDeviseExpedition() {
                ...
                if (devise) {
                    ...
                    document.getElementById('devise_expedition_info').textContent =
                        'Devise de l\'agence sélectionnée';
                    ...
                    updateAllDevises('XOF');
                }
            }

            async function updateConteneurEtReference() {
                const modeTransit = document.getElementById('mode_transit').value;
                const agenceExpeditionId = document.getElementById('agence_expedition_id').value;

                if (!modeTransit || !agenceExpeditionId) {
                ...
                try {
                    const url = "{{ route('colis.get-conteneur-reference') }}";
                    const params = new URLSearchParams({
                        mode_transit: modeTransit,
                        agence_expedition_id: agenceExpeditionId
                    });
                    ...
                    if (data.success) {
                        ...
                        updateConteneurInfo(data.conteneur);
                        ...
                        if (data.agenceExpedition) {
                            updateDeviseExpeditionDisplay(data.agenceExpedition.devise);
                        }
