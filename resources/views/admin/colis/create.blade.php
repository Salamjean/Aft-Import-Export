                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="info-field bg-light rounded p-3 text-center h-100 d-flex flex-column justify-content-center">
                                            ...
                                            <small class="text-muted mt-1" id="devise_expedition_info">Sélectionnez une agence</small>
                                        </div>
                            ...
                            <div id="colis-container">
                                <div class="colis-item card mb-4 border-0 shadow-sm" data-index="0" 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" class="type-calcul-input" name="colis[0][type_calcul]" value="manuel">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePrixKgDisplay() {
        ...
        if (modeTransit === 'Aerien') {
            if (devise === 'EUR') {
                ...
                prixKgDisplay.textContent = `${(15 * TAUX_CONVERSION_EURO_XOF).toFixed(0)} XOF par kg (prix forfaitaire par colis)`;
            }
        }
    }
        document.getElementById('mode_transit').addEventListener('change', function() {
    ...
    function addColis() {
        ...
        typeCalculInput.value = document.getElementById('mode_transit').value === 'Aerien' ? 'auto_poids' : 'manuel';
    ...
    function updateRecap() {
        ...
        const agenceExpedition = agenceExpeditionSelect.options[agenceExpeditionSelect.selectedIndex]?.textContent || '-';
        ...
        // Services
        const serviceSelect = document.getElementById('service_id');
        const service = serviceSelect.options[serviceSelect.selectedIndex]?.textContent || 'Aucun service supplémentaire';
        ...
        document.getElementById('recap_service').textContent = service.includes('Aucun') ? 'Aucun service' : service.split(' - ')[0] || service;
        ...
        document.getElementById('recap_montant_total').textContent = (parseFloat(montantTotalDisplay) || 0).toFixed(2) + ' ' + devise;
