            ...
            <div class="page-header bg-gradient-primary rounded-3 p-4 shadow">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="{{ route('depot.create') }}" class="btn btn-light btn-lg rounded-pill px-4">
...
async function showDetails(depotId) {
    ...
    try {
        const response = await fetch(`/admin/schedule/${depotId}/details`);
...
function showEtiquettes(depotId) {
    ...
    setTimeout(() => {
        window.open(`/admin/schedule/${depotId}/etiquettes`, '_blank');
...
function downloadEtiquettes(depotId) {
    ...
    setTimeout(() => {
        window.open(`/admin/schedule/${depotId}/download-etiquettes`, '_blank');
...
async function deleteDepot(depotId) {
    try {
        ...
        const response = await fetch(`/admin/schedule/${depotId}`, {
            method: 'POST',
            body: formData,
            headers: {
...
function editDepot(depotId) {
    ...
    setTimeout(() => {
        window.location.href = `/admin/schedule/${depotId}/edit`;
    }, 1100);
}
